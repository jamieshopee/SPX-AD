...
Version: v0.5.4（SPX Helper Runtime Productization Phase 1 Foundation Completed；Next: Phase 2 — Windows Packaging）
...
SPX Helper Core 已完成（功能 Commit `9a71794`），Runtime Productization Phase 1 Foundation 亦已完成（功能 Commit `51c4828`）。Phase 1 在既有 Core 外新增 Product Host，負責 Running／Working／Attention、單一 Helper Instance、固定 Tray／Menu Bar、Quit 與 Restart；Core、Runtime Contract、Browser API、Frontend、Platform Adapter、Photoshop Automation、AI Workflow、Review Workspace 與 Render Pipeline 均未修改。Browser／Platform Validation 與 Jamie Manual Validation 均 PASS。Installer、Windows MSI、macOS PKG、登入自動啟動、更新、解除安裝、簽章與 release packaging 尚未完成。

## What's New

- **SPX Helper Runtime Productization Phase 1 Foundation — Completed（功能 Commit `51c4828`）**：新增 `spx_helper_product.py` Product Host、Running／Working／Attention、單一 Helper Instance、固定 Tray／Menu Bar、Open、About、Version、Restart 與 Quit。Browser／Platform Validation 與 Jamie Manual Validation 均 PASS；下一步為 Phase 2 — Windows Packaging。
...
- Photoshop Automation 與 AI Workflow 已完成 Coding 並通過 macOS Development Manual Validation（Photoshop 2025，Stage 1–4 共 18 項 PASS），已完成 Final Sign-off（Tag `v0.5.0`）。兩者皆列入 Locked Completed Phases。Windows Development Validation 與 Jamie Manual Validation 已在 Photoshop 2025 實機 PASS。SPX Helper Core 與 Productization Phase 1 Foundation 後續亦已完成；Phase 2～5 仍依已通過的 Implementation Proposal 分階段進行。詳見下方「SPX Helper Runtime Productization」、「SPX Helper Architecture」、「Photoshop Automation Architecture」與「AI Workflow Architecture」。
...
14. [SPX Helper Architecture](#spx-helper-architecturecore-completed)
15. [Photoshop Automation Architecture](#photoshop-automation-architecturecompleted)
16. [AI Workflow Architecture](#ai-workflow-architecturecompleted)
17. [QR Code Architecture](#qr-code-architecturecompleted)
18. [Documentation Structure](#documentation-structure)
19. [資料夾結構](#資料夾結構)
20. [新增 Style 流程](#新增-style-流程)
21. [維護原則](#維護原則)
...
Next
  └─ Phase 2 — Windows Packaging（Not Started）
...
Remaining Productization Phases
  ├─ Phase 2 — Windows Packaging（Next）
...
Review Workspace（Crop / Eraser）、Photoshop Rerun Automation、Review Workspace UX Polish、Project Persistence、UI Upgrade、Photoshop Automation、AI Workflow、Render Context & Export Workflow、QR Code、SPX Helper Core 與 SPX Helper Runtime Productization Phase 1 Foundation 皆已完成。Phase 1 功能 Commit 為 `51c4828`，Browser／Platform Validation 與 Jamie Manual Validation 均 PASS。下一步為 **Phase 2 — Windows Packaging（Not Started）**；Phase 3～5 尚未開始。不得將 Photoshop 2025 驗證結果延伸為支援所有 Photoshop 版本。
...
- Installer、Windows MSI、macOS PKG、登入自動啟動、Update、Uninstall、Signing 與 Final Validation 均不在 Phase 1，尚未完成。
...
- SPX Helper Core 與 Productization Phase 1 Foundation 已完成；Phase 2 Windows Packaging、Phase 3 macOS Packaging、Phase 4 Update + Uninstall 與 Phase 5 Final Validation 尚未完成。
