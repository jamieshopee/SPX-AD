...
Version: v0.5.4（SPX Helper Runtime Productization Phase 2 Windows Packaging Completed；Next: Phase 3 — macOS Packaging）
...
SPX Helper Core（功能 Commit `9a71794`）、Runtime Productization Phase 1 Foundation（功能 Commit `51c4828`）與 Phase 2 Windows Packaging（功能 Commit `9240504`）均已完成。Phase 1 在既有 Core 外新增 Product Host lifecycle；Phase 2 以 PyInstaller 封裝該 Product Host，並以 WiX Toolset SDK 5.0.2 建立 per-machine MSI、安裝後立即啟動、登入自動啟動、Start Menu 與 Apps & Features。Windows 實機已完成 GitHub Pages → SPX Helper → Photoshop → Processed PNG。macOS PKG、Update／Uninstall 與 Final Validation 尚未完成。

## What's New

- **SPX Helper Runtime Productization Phase 2 Windows Packaging — Completed（功能 Commit `9240504`）**：以 PyInstaller 建立 executable bundle，並以 WiX Toolset SDK 5.0.2 建立 per-machine MSI。Fresh Install、安裝後立即啟動、Login Startup、Start Menu、Apps & Features、System Tray 與正式 Windows Happy Path 均已實機 PASS；下一步為 Phase 3 — macOS Packaging。
...
- Photoshop Automation 與 AI Workflow 已完成 Coding 並通過 macOS Development Manual Validation（Photoshop 2025，Stage 1–4 共 18 項 PASS），已完成 Final Sign-off（Tag `v0.5.0`）。兩者皆列入 Locked Completed Phases。Windows Development Validation 與 Jamie Manual Validation 已在 Photoshop 2025 實機 PASS。SPX Helper Core、Productization Phase 1 Foundation 與 Phase 2 Windows Packaging 後續亦已完成；Phase 3～5 仍依已通過的 Implementation Proposal 分階段進行。詳見下方「SPX Helper Runtime Productization」、「SPX Helper Architecture」、「Photoshop Automation Architecture」與「AI Workflow Architecture」。
...
15. [SPX Helper Architecture](#spx-helper-architecturecore-completed)
16. [Photoshop Automation Architecture](#photoshop-automation-architecturecompleted)
17. [AI Workflow Architecture](#ai-workflow-architecturecompleted)
18. [QR Code Architecture](#qr-code-architecturecompleted)
19. [Documentation Structure](#documentation-structure)
20. [資料夾結構](#資料夾結構)
21. [新增 Style 流程](#新增-style-流程)
22. [維護原則](#維護原則)
...
Remaining Productization Phases
  ├─ Phase 3 — macOS Packaging（Next）
  ├─ Phase 4 — Update + Uninstall
...
Review Workspace（Crop / Eraser）、Photoshop Rerun Automation、Review Workspace UX Polish、Project Persistence、UI Upgrade、Photoshop Automation、AI Workflow、Render Context & Export Workflow、QR Code、SPX Helper Core、SPX Helper Runtime Productization Phase 1 Foundation 與 Phase 2 Windows Packaging 皆已完成。Phase 2 功能 Commit 為 `9240504`，Windows MSI Build／Install 與正式 Happy Path 均 PASS。下一步為 **Phase 3 — macOS Packaging（Not Started）**；Phase 4～5 尚未開始。不得將 Photoshop 2025 驗證結果延伸為支援所有 Photoshop 版本。
...
- 下一步為 Phase 3 — macOS Packaging；Phase 4 Update + Uninstall 與 Phase 5 Final Validation 尚未完成。
...
- SPX Helper Core、Productization Phase 1 Foundation 與 Phase 2 Windows Packaging 已完成；Phase 3 macOS Packaging、Phase 4 Update + Uninstall 與 Phase 5 Final Validation 尚未完成。
