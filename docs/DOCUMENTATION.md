...
- QR Code is Next but Not Started: do not open a QR Code Proposal, and do not describe it as Active Phase or in progress, until the product owner explicitly starts one.
