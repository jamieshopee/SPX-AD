...
- 新增 Project State PS-2A：Project State v4 persist Asset Pipeline metadata。
...
1. [Unreleased - Project State PS-2A](#unreleased---project-state-ps-2a)
...
## Unreleased - Project State PS-2A

### Added

- Project State 升級為 version 4。
