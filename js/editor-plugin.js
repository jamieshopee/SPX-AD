...
(function(){
  ...
  function makeEditor(){
    ...
    function applyToTarget(){
      ...
      try {
        productUrl = productOnly.toDataURL('image/png');
        finalUrl   = final.toDataURL('image/png');
      } catch(e) {
        setStatus('套用失敗：' + (e.message || String(e)));
        return;
      }
