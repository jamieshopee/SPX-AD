...
PROFILE_DIR="$PROJECT_DIR/chrome-profiles/984x309"

# 1. 關閉使用此 profile 的舊 Chrome
pkill -f "chrome-profiles/984x309" 2>/dev/null || true
sleep 0.6
...
/Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome \
  ...
  --disk-cache-size=1 \
  "http://localhost:8080/editor/index.html?_v=$TS&template=templates/984x309/template.json&style=01" \
  2>/dev/null &
